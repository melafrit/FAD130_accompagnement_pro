        ...
        <div className="authmenu-dropdown" role="menu">
          {user ? (
            ...
            <div className="authmenu-foot authmenu-foot-out">
              <Link className="btn btn-primary" to="/connexion" onClick={() => setOpen(false)}>Connexion</Link>
              <Link className="btn btn-ghost" to="/inscription" onClick={() => setOpen(false)}>Inscription</Link>
            </div>
          )}
        </div>
      )}
